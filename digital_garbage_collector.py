...
print('public key {}'.format(test_wallet.public_key) )
print('private key {}'.format(test_wallet.private_key) )
print('seed {}'.format(test_wallet.seed) )
print('sequence {}'.format(test_wallet.sequence) )
